    ...
    <form onSubmit={handleSubmitAddOneRow}>
      <div className="container">
        ...
        <FormField label="Reference Number">
          <div className="field has-addons">
            ...
            <button
              ...
              type="button"
              disabled={
                systemReference === 'None' ? true : false || props.role === 'ct reviewer'
              }
            >
              <span className="icon">
            ...
            <div className="field has-addons">
              ...
              <p className="control">
                <input
                  ...
                  //         : null
                  // }
                  onBlur={() => handleBlurReferenceNumber(referenceNumber2, 2)}
                />
              </p>
            </div>
          </FormField>
          ...
          <div className="field">
            <p className="control is-expanded has-icons-left">
              <input
                ...
                onBlur={() => (props.handleonblur ? props.handleonblur({ phone }) : null)}
                disabled={props.role === 'ct reviewer'}
              />
              <span className="icon is-small is-left">
                <FontAwesomeIcon icon={['fas', 'phone']} size="1x" flip="horizontal" />
              </span>
            </p>
          </div>
          <div className="field">
            <p className="control is-expanded has-icons-left has-icons-right">
              <input
                ...
                onBlur={() => (props.handleonblur ? props.handleonblur({ email }) : null)}
                disabled={props.role === 'ct reviewer'}
              />
              <span className="icon is-small is-left">
            ...
            <div className="control">
              <div className="select is-fullwidth">
                <select
                  ...
                  autoFocus={props.role === 'ct reviewer' ? true : false}
                  required
                >
                  <option value="solved">Solved</option>
                  <option value="pending">Pending</option>
                  <option value="waiting for cs answer">Waiting for cs answer</option>
                </select>
              </div>
            </div>
          </div>
        ...
        <div className="buttons is-right mt-5">
          <button className="button is-primary mr-4" id="submit-row-button" type="submit">
