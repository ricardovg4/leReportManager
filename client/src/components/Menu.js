  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul className="menu-list">
          <li>
            <a className="has-text-white" onClick={props.toggletrackingrender}>
              Track an order
            </a>
          </li>
          <li>
          ...
          <li>
            <a className="has-text-white" onClick={props.togglestatisticsrender}>
              Statistics
            </a>
          </li>
          <li>
            <a className="has-text-white" onClick={props.togglereportstatsrender}>
              Report stats
            </a>
          </li>
        </ul>
